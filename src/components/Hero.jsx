      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 lg:pr-12 mb-12 lg:mb-0" data-aos="fade-right">
            ...
            <h1 className="font-premium text-4xl md:text-6xl lg:text-7xl leading-tight text-[#708238] mb-6">
              Nature's Own <br />
          ...
          <div className="w-full lg:w-1/2 relative" data-aos="fade-left">
            <div className="relative">
              ...
              >
                ...
                <p className="text-xs text-[#708238] font-premium">100% Natural Ingredients</p>
              </div>
              ...
              >
                ...
                <p className="text-xs text-[#708238] font-premium">Ethically Sourced</p>
              </div>
            </div>
          </div>
        </div>
